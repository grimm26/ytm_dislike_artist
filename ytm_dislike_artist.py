...
def get_artist(client, artist_name):
    ...
    return client.get_artist(client.search(query=artist_name, filter='artists', ignore_spelling=True)[0]['browseId'])
...
def main():
    ...
    try:
        ...
        print('You need to create a headers_auth.json, see  https://ytmusicapi.readthedocs.io/en/latest/setup.html')
    else:
